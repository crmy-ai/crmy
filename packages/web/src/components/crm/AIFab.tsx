...
export function AIFab() {
  ...
  const { toggleAgentPanel, agentPanelOpen } = useAppStore();
    ...
    <AnimatePresence>
      {!agentPanelOpen && (
        ...
        >
          ...
          <span className="hidden md:inline-flex items-center gap-0.5 text-xs font-mono text-muted-foreground bg-card/80 backdrop-blur-sm border border-border px-1.5 py-0.5 rounded-md shadow-sm">
