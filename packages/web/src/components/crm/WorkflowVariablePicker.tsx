  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-mono text-muted-foreground hover:text-foreground hover:bg-muted border border-border transition-colors"
      >
      ...
      {open && (
        <div className="absolute z-50 right-0 top-full mt-1 w-52 bg-popover border border-border rounded-lg shadow-lg overflow-hidden">
          <div className="px-2.5 py-1.5 border-b border-border text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">
            Insert variable
          </div>
          <div className="max-h-56 overflow-y-auto">
            {groups.map(group => {
              ...
              return (
                <div key={group}>
                  <div className="px-2.5 py-1 text-[10px] font-semibold text-muted-foreground bg-muted/40">
                    {group}
                  </div>
                  {items.map((s: VariableSuggestion) => (
                    ...
                    >
                      <span className="font-mono text-[11px] text-foreground">&#123;&#123;{s.path}&#125;&#125;</span>
