...
export function buildSpec() {
  ...
  const doc = generator.generateDocument({
    ...
    tags: [
      ...
      { name: 'Context', description: 'Sources, Signals, and confirmed Memory attached to customer records' },
      { name: 'Source Filters', description: 'Controls for excluding internal, automated, spam, and low-value source material' },
      ...
      { name: 'Emails', description: 'Customer email ingestion, mailbox connections, Source processing, and governed outbound drafts' },
      { name: 'Calendar', description: 'Customer meeting capture and activity context processing' },
      { name: 'Messaging', description: 'Tenant messaging channels for workflow and sequence notifications' },
      { name: 'Sequences', description: 'Experimental governed customer engagement sequences and enrollment state' },
      { name: 'Custom Fields', description: 'Per-tenant field definitions for any object type' },
      { name: 'Workflows', description: 'Experimental event-driven automation' },
      ...
      { name: 'Operations', description: 'Tenant operational health, data quality, and recovery controls' },
      { name: 'Admin', description: 'Workspace setup, users, actors, sample data, and local database configuration' },
