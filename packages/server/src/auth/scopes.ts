...
const TOOL_SCOPES: Record<string, string[]> = {
  ...
  account_split_domains: ['accounts:write'],
  ...
  // ── Use Cases ──
  use_case_get: ['use_cases:read'],
  use_case_search: ['use_cases:read'],
  use_case_list_contacts: ['use_cases:read'],
  use_case_get_timeline: ['use_cases:read'],
  use_case_summary: ['use_cases:read'],
  use_case_create: ['use_cases:write'],
  use_case_update: ['use_cases:write'],
  use_case_delete: ['use_cases:write'],
  use_case_advance_stage: ['use_cases:write'],
  use_case_update_consumption: ['use_cases:write'],
  use_case_set_health: ['use_cases:write'],
  use_case_link_contact: ['use_cases:write', 'contacts:read'],
  use_case_unlink_contact: ['use_cases:write'],
  ...
  context_source_connection_list: ['systems:read'],
  context_source_connection_create: ['systems:admin'],
  context_source_connection_update: ['systems:admin'],
  context_source_connection_delete: ['systems:admin'],
  context_source_connection_sync: ['systems:admin'],
  context_source_object_list: ['activities:read', 'context:read'],
  context_source_object_get: ['activities:read', 'context:read'],
  context_source_object_resolve: ['activities:write', 'context:write'],
  context_source_object_reprocess: ['activities:write', 'context:write'],
  context_source_object_ignore: ['activities:write'],
  email_provider_set: ['email_provider:admin'],
  ...
  webhook_reveal_secret: ['webhooks:write'],
  webhook_rotate_secret: ['webhooks:write'],
