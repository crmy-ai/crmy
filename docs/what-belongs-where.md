...
| **Context** | Sources, Signals, Memory, Lineage, source processing receipts, context search. | Inbox-style email triage, calendar management, automation builders. |
...
- **Sources** are source material before extraction.
...
- Keep Sources, Signals, Memory, Active Context, Handoffs, writebacks, receipts, and audit events as separate lifecycle states.
...
- Prefer secondary links for expert tools such as Graph, Sources, Webhooks, and experimental automation surfaces.
...
- Say **Experimental Action Rules** or **experimental automation surfaces** when workflow-builder or sequence functionality is visible.
