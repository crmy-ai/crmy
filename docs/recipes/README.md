...
Every recipe runs **connector-free** — they need only seeded or ingested context, not a CRM/warehouse connector. Run `npx -y @crmy/cli quickstart` first to confirm the seeded golden path works end to end.
