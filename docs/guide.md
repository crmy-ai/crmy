...
Legacy `/api/v1/email-sequences/*` routes remain available for older integrations, but new integrations should use `/api/v1/sequences/*` and the canonical `sequence_*` MCP tools.
